...
def save_video(tensor,
    ...
    try:
        ...
        # CRF 23 (x264 default) is perceptually near-transparent for this soft
        # ~480p generated video while producing ~3x smaller files than CRF 18.
        # Constant-quality (CRF) already lets bitrate track motion per clip.
        if not 0 <= crf <= 51:
